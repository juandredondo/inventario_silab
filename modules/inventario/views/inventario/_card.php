            ...
            <div class="box-tools pull-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::toRoute(["/inventario/inventario/view", "id" => $model->INVE_ID]) ?>"><i class="icon-bottom material-icons md-18">assignment</i> <span class="hidden-xs">ITEMS</span></a></li>
                        <li><a href="<?= Url::toRoute(["/inventario/inventario/flows", "id" => $model->INVE_ID]) ?>"><i class="icon-bottom fa-rotate-90 material-icons md-18">compare_arrows</i> <span class="hidden-xs">FLUJOS</span></a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="#"><i class="icon-bottom material-icons md-18">delete</i> <span class="hidden-xs">ELIMINAR</span></a></li>
                    </ul>
                </div>
            </div><!-- /.box-tools -->
        </div><!-- /.box-header -->
