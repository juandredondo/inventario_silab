...
use app\modules\admin\models\PermisoSeach;
...
class PermisoController extends Controller
{
    ...
    {    
        $searchModel    = new PermisoSeach();
        $dataProvider   = $searchModel->search(Yii::$app->request->queryParams);
        // - - - - - - - - - - - - - - - - - - - - - - - - - - -
        $roleModel      = new RolSearch;
        $roleProvider   = $roleModel->search(Yii::$app->request->queryParams);
        return $this->render('index', [
            'searchModel'   => $searchModel,
            'dataProvider'  => $dataProvider,
            'roleSearch'    => $roleModel,
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Permiso",
                    'content'=>'<span class="text-success">Create Permiso success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->PERM_ID]);
            } else {
    ...
    /**
     * Delete an existing Permiso model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Permiso model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
